/**
 * planner.js — the core scheduling engine.
 *
 * buildPlan() turns a user's tasks, goals, commitments and preferences into a
 * balanced, realistic schedule. The same engine is used as:
 *   1. the local fallback (works with zero configuration), and
 *   2. the validator/sanitizer for the LLM-produced structured JSON schedule.
 *
 * Logic:
